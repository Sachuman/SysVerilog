...
def test_each_runner(test_name, DataWidth):
...
class RandomDataGenerator():
    ...
    def generate(self):
        a_i = random.randint(0, (1 << self._dut.DataWidth.value) - 1)
        b_i = random.randint(0, (1 << self._dut.DataWidth.value) - 1)
        return (a_i, b_i)
...
class EdgeCaseGenerator():
    ...
    def __init__(self, dut):
        self._dut = dut
        limits = [0, 1, (1 << self._dut.DataWidth.value) - 1]
